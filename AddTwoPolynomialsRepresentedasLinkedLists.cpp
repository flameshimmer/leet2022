...
//coefficient of the term 9x4 is 9.
//power: an integer representing the exponent. The power of the term 9x4 is 4.
//next: a pointer to the next node in the list, or null if it is the last node of
//the list.
...
//as its [coefficient, power]. For example, the polynomial 5x3 + 4x - 7 would be
//represented as: [[5,3],[4,1],[-7,0]].
// 
//
//Example 1:
...
//Output: [[5,2],[2,0]]
//Explanation: poly1 = 2x2 + 4x + 3. poly2 = 3x2 - 4x - 1. The sum is 5x2 + 2.

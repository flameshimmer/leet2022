...
//should remove any positive number of stones from a non-empty pile of his or her
//choice. The first player who cannot make a move loses, and the other player
//wins.
//Given an integer array piles, where piles[i] is the number of stones in the ith
//pile, return true if Alice wins, or false if Bob wins.
...
//Input: piles = [1,1]
//Output: false
//Explanation: It can be proven that Bob will always win. One possible scenario
//is:
...
//Explanation: It can be proven that Bob will always win. One possible scenario
//is:
//- On the first turn, Alice removes three stones from the third pile. piles =
//[1,2,0].

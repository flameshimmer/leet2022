...
//represents the statements made by n people about each other. More specifically,
//statements[i][j] could be one of the following:
...
//    - Based on the statement made by person 0, person 1 is a bad person and was
//lying.

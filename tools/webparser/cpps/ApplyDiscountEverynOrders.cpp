...
//                                                     // bill = 10 * 300 + 10 *
//100 = 4000.
//cashier.getBill([1,2,3,4,5,6,7],[1,1,1,1,1,1,1]);    // return 800.0. 3rd
...
//customer, no discount.
//cashier.getBill([7,5,3,1,6,4,2],[10,10,10,9,9,9,7]); // return 7350.0. 6th
//customer, 50% discount.
//                                                     // Original bill = 14700,
//but with
//                                                     // Actual bill = 14700 *
//((100 - 50) / 100) = 7350.
//cashier.getBill([2,3,5],[5,3,2]);                    // return 2500.0.  6th
//customer, no discount.
// 
//Constraints:
//1 <= n <= 104

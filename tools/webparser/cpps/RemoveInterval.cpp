...
//intervals. In other words, return the set of real numbers such that every x in
//the set is in intervals but not in toBeRemoved. Your answer should be a sorted

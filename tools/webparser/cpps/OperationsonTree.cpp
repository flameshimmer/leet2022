...
//locking the same node. You may only lock a node using this function if the node
//is unlocked.
...
//upgrade(int num, int user) returns true if it is possible for the user with id
//user to upgrade the node num, or false otherwise. If it is possible, the node

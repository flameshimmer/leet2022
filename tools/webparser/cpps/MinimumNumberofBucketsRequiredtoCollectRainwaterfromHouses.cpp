...
//You can place buckets on the empty spaces to collect rainwater that falls from
//the adjacent houses. The rainwater from a house at index i is collected if a
...
//Return the minimum number of buckets needed so that for every house, there is
//at least one bucket collecting rainwater from it, or -1 if it is impossible.
// 
//
//Example 1:
//Input: street = "H..H"
...
//The house at index 0 has a bucket to its right, and the house at index 3 has a
//bucket to its left.
...
//The house at index 1 has a bucket to its right, and the house at index 3 has a
//bucket to its left.
//Thus, for every house, there is at least one bucket collecting rainwater from
//it.
//

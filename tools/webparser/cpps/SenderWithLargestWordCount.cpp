...
//or trailing spaces. The word count of a sender is the total number of words
//sent by the sender. 
...
//with the largest word count, return the one with the lexicographically largest
//name.
//
//Note:
...
//
//Example 1:
//Input: messages = ["Hello userTwooo","Hi userThree","Wonderful day Alice","Nice

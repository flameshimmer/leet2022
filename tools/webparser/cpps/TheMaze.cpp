...
//destinationcol], return true if the ball can stop at the destination, otherwise
//return false.
...
//Both the ball and the destination exist in an empty space, and they will not be

...
//with the row index in the range [1, height] and the column index in the range
//['A', width]. All the values should be zero initially.
...
//value at mat[row][column]. This sum formula should exist until this cell is
//overlapped by another value or another sum formula. numbers[i] could be on the
//format:
...
//For example, "B3:F7" represents the cells mat[i][j] for 3 <= i <= 7 and 'B' <=
//j <= 'F'.
//
...
//the rectangle range whose top-left cell is mat[1]["A"] and bottom-right cell is
//mat[2]["B"].
// //   A B C
// // 1 2 0 0
// // 2 0 0 0
...
//excel.set(2, "B", 2);
// // set mat[2]["B"] to be 2. 
//Note mat[3]["C"] should also be changed.
// //   A B C
// // 1 2 0 0
// // 2 0 2 0
// // 3 0 0 6

...
//duty on the ith day. The days are numbered starting from 0. You are also given
//an integer time.
...
//security[5].
//No other days satisfy this condition, so days 2 and 3 are the only good days to
//rob the bank.
//
//Example 2:

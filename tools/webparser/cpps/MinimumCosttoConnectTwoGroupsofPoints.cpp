...
//and point j of the second group. The groups are connected if each point in both
//groups is connected to one or more points in the opposite group. In other
//words, each point in the first group must be connected to at least one point in
//the second group, and each point in the second group must be connected to at
//least one point in the first group.

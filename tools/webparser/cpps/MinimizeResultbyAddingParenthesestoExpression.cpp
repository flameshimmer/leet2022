...
//parentheses, expression is a valid mathematical expression and evaluates to the
//smallest possible value. The left parenthesis must be added to the left of '+'

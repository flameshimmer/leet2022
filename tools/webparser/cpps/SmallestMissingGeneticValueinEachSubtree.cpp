...
//range [1, 105]. You are given a 0-indexed integer array nums, where nums[i] is
//a distinct genetic value for node i.
//Return an array ans of length n where ans[i] is the smallest genetic value that
//is missing from the subtree rooted at node i.

...
//longest substring of s consisting of only one repeating character after the ith
//query is performed.
// 
//
//Example 1:
...
//Output: [3,3,4]
//Explanation: 
//- 1st query updates s = "bbbacc". The longest substring consisting of one
//repeating character is "bbb" with length 3.
//- 2nd query updates s = "bbbccc". 
//  The longest substring consisting of one repeating character can be "bbb" or
//"ccc" with length 3.
//- 3rd query updates s = "bbbbcc". The longest substring consisting of one
...
//Output: [2,3]
//Explanation:
//- 1st query updates s = "abazz". The longest substring consisting of one
//repeating character is "zz" with length 2.
//- 2nd query updates s = "aaazz". The longest substring consisting of one

...
//void put(int id, string timestamp) Stores the given log (id, timestamp) in your
//storage system.
//int[] retrieve(string start, string end, string granularity) Returns the IDs of
...
//"Day" means that we need to find the logs within the inclusive range from Jan.
//1st 2017 to Jan. 2nd 2017, and the Hour, Minute, and Second for each log entry
//can be ignored.
// 
//
//Example 1:

...
//getWidth(fontSize, text[i]) call for each 0 <= i < text.length (0-indexed). The
//calculated height of text for some fontSize is getHeight(fontSize). 
//Note that
...
//Return the maximum font size you can use to display text on the screen. If text

...
//totally new battery or a battery from another computer. You may assume that the
...
//second computer.
//After two minutes, remove battery 1 from the second computer and insert battery
//2 instead. 
...
//We can run the two computers simultaneously for at most 4 minutes, so we return
//4.
//
//Example 2:
...
//computer. 
//After another minute, battery 1 and battery 3 are also drained so the first and
//second computers are no longer running.
//We can run the two computers simultaneously for at most 2 minutes, so we return
//2.
// 
//Constraints:

...
//were [0, 0, 1], then their compatibility score is 2 because only the second and
//the third answers are the same.
//You are tasked with finding the optimal student-mentor pairings to maximize the
//sum of the compatibility scores.
//Given students and mentors, return the maximum compatibility score sum that can
//be achieved.
// 
//
//Example 1:

...
//order(n) is a binary tree that consists of a root node with the left subtree as
//order(n - 2) and the right subtree as order(n - 1).
...
//Given the integer n, return true if Alice wins the game or false if Bob wins,

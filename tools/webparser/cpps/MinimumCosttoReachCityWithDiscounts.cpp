...
//discounts you have. You can use a discount to travel across the ith highway for
//a cost of tolli / 2 (integer division). Each discount may only be used once,
...
//
//Example 1:
//Input: n = 5, highways = [[0,1,4],[2,1,3],[1,4,11],[3,2,3],[3,4,2]], discounts
//= 1
//Output: 9
//Explanation:
...
//
//Example 2:
//Input: n = 4, highways = [[1,3,17],[1,2,7],[3,2,5],[0,1,6],[3,0,20]], discounts
//= 20
//Output: 8
//Explanation:

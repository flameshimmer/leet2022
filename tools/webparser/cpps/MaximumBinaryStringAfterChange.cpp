...
//Operation 1: If the number contains the substring "00", you can replace it with
//"10".
//For example, "00010" -> "10010"
//Operation 2: If the number contains the substring "10", you can replace it with
//"01".

...
//rather weak team, like make the rank 1 team play with the rank nth team, which
...
//The n teams are labeled from 1 to n, which represents their initial rank (i.e.,
...
//Output: "((1,4),(2,3))"
//Explanation:
//In the first round, we pair the team 1 and 4, the teams 2 and 3 together, as we

...
//if the distance between where you are currently at (the floor or on a rung) and
//the next rung is at most dist. You are able to insert rungs at any positive

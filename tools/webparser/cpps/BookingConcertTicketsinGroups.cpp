...
//can be allocated seats in rows 0 to maxRow, who may or may not sit together. If
//the seats can be allocated, it allocates k seats to the group with the smallest
//row numbers, and the smallest possible seat numbers in each row. Otherwise,
//returns false.
// 
//
//Example 1:

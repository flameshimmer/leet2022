...
//DinnerPlates(int capacity) Initializes the object with the maximum capacity of
//the stacks capacity.
//void push(int val) Pushes the given integer val into the leftmost stack with a

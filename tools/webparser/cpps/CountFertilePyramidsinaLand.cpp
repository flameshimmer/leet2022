...
//An inverse pyramidal plot of land can be defined as a set of cells with similar
//criteria:
//The number of cells in the set has to be greater than 1 and all cells must be
//fertile.
//The apex of an inverse pyramid is the bottommost cell of the inverse pyramid.
//The height of an inverse pyramid is the number of rows it covers. Let (r, c) be
//the apex of the pyramid, and its height be h. Then, the plot comprises of cells
//(i, j) where r - h + 1 <= i <= r and c - (r - i) <= j <= c + (r - i).

...
//For each section of the target with score k (in between 0 to 11), say Alice and
//Bob have shot ak and bk arrows on that section respectively. If ak >= bk, then
//Alice takes k points. If ak < bk, then Bob takes k points.

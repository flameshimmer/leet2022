...
//- At the 1st second, 1 bit of memory is allocated to stick 1. The first stick
//now has 1 bit of available memory.
//- At the 2nd second, 2 bits of memory are allocated to stick 2. The second
...
//Output: [6,0,4]
//Explanation: The memory is allocated as follows:
//- At the 1st second, 1 bit of memory is allocated to stick 2. The second stick
//now has 10 bit of available memory.
//- At the 2nd second, 2 bits of memory are allocated to stick 2. The second
//stick now has 8 bits of available memory.
//- At the 3rd second, 3 bits of memory are allocated to stick 1. The first stick
//now has 5 bits of available memory.
//- At the 4th second, 4 bits of memory are allocated to stick 2. The second
//stick now has 4 bits of available memory.
//- At the 5th second, 5 bits of memory are allocated to stick 1. The first stick
//now has 0 bits of available memory.

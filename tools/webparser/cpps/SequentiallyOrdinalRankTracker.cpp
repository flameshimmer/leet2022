...
//tracker.add("bradford", 2); // Add location with name="bradford" and score=2 to
//the system.
//tracker.add("branford", 3); // Add location with name="branford" and score=3 to
//the system.
...
//higher score (3 > 2).
//                            // This is the 1st time get() is called, so return
//the best location: "branford".
//tracker.add("alps", 2);     // Add location with name="alps" and score=2 to the
//system.
...
//                            // Return the 2nd best location "alps", as it is
//the 2nd time get() is called.
//tracker.add("orland", 2);   // Add location with name="orland" and score=2 to
//the system.
//tracker.get();              // Sorted locations: branford, alps, bradford,
//orland.
//                            // Return "bradford", as it is the 3rd time get()
//is called.

...
//The size of the array at time t, sizet, must be at least nums[t] because there
//needs to be enough space in the array to hold all the elements. The space
//wasted at time t is defined as sizet - nums[t], and the total space wasted is
//the sum of the space wasted across every time t where 0 <= t < nums.length.
...
//We can set the initial size to 10, resize to 20 at time 1, and resize to 30 at
//time 3.

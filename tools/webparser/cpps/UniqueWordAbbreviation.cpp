...
//validWordAbbr.isUnique("cart"); // return true, no words in the dictionary have
//the abbreviation "c2t".
...
//validWordAbbr.isUnique("make"); // return true, no words in the dictionary have
//the abbreviation "m2e".

...
//
//Note that this is not the only way to end with 5 at the top of the pile. It can
//be shown that 5 is the largest answer possible after 4 moves.
//
//Example 2:
//Input: nums = [2], k = 1
//Output: -1
...
{
	namespace MaximizetheTopmostElementAfterKMoves
	{

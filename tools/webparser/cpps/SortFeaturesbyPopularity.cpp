...
//represents the name of a feature of the latest product you are working on. You
//have made a survey where users have reported which features they like. You are
//given a string array responses, where each responses[i] is a string containing

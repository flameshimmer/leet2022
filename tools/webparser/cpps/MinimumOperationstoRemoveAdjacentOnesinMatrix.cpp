...
//You are given a 0-indexed binary matrix grid. In one operation, you can flip
//any 1 in grid to be 0.
...
//Output: 3
//Explanation: Use 3 operations to change grid[0][1], grid[1][2], and grid[2][1]
//to 0.

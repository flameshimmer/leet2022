...
//- queries[0] = [0,1]: The subarray is [1,3] and the minimum absolute difference
//is |1-3| = 2.
//- queries[1] = [1,2]: The subarray is [3,4] and the minimum absolute difference
//is |3-4| = 1.
//- queries[2] = [2,3]: The subarray is [4,8] and the minimum absolute difference
//is |4-8| = 4.
...
//Output: [-1,1,1,3]
//Explanation: The queries are processed as follows:
//- queries[0] = [2,3]: The subarray is [2,2] and the minimum absolute difference
//is -1 because all the

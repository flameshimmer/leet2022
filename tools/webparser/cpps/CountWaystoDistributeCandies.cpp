...
//2 and 3 in the bag (2,3) in the first way are not in the same bag in the second
//way (they are split between the bags (2) and (1,3)). However, (1), (2,3) and
//(3,2), (1) are considered the same because the candies in each bag are all in
//the same bags in both ways.
...
//1881780996 modulo 109 + 7 = 206085257.
// 
//Constraints:
//1 <= k <= n <= 1000

...
//expression e2, and so on sequentially; and then the value of this let
...
//"mult", there are always two expressions e1, e2 and the result is the
...
//starts with a lowercase letter, then zero or more lowercase letters or digits.
...
//outer scopes are checked sequentially. It is guaranteed that every expression
//is legal. Please see the examples for more details on the scope.
// 
//
//Example 1:

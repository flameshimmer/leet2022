...
//in a warehouse respectively. The warehouse's rooms are labelled from 0 to n - 1
...
//room 2 instead.
//Swapping the orange and green boxes is also valid, or swapping one of them with
//the red box.
//
//Example 3:

...
//ArrayReader.length(). The function returns the distribution of the value of the
//4 elements and returns:
//4 : if the values of the 4 elements are the same (0 or 1).
//2 : if three elements have a value equal to 0 and one element has value equal
//to 1 or vice versa.
//0 : if two element have a value equal to 0 and two elements have a value equal
//to 1.

...
//In each move, you may take an unbroken egg and drop it from any floor x (where
...
//and going up one at a time to find f within 12 more drops. Total drops is 2 +
//12 = 14.

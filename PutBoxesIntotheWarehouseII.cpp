...
//representing the heights of some boxes of unit width and the heights of n rooms
//in a warehouse respectively. The warehouse's rooms are labeled from 0 to n - 1
...
//Notice that there are other valid ways to put 4 boxes such as swapping the red
//and green boxes or the red and orange boxes.
//
//Example 2:
//Input: boxes = [3,5,5,2], warehouse = [2,1,3,4,5]
//Output: 3
//Explanation:
//It is not possible to put the two boxes of height 5 in the warehouse since

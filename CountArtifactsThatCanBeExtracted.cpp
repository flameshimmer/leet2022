...
//c2i] denotes that the ith artifact is buried in the subgrid where:
...
//Output: 1
//Explanation: 
//The different colors represent different artifacts. Excavated cells are labeled
//with a 'D' in the grid.

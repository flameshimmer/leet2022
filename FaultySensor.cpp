...
//points to the right of the dropped data are shifted one place to the left, and
//the last data point is replaced with some random value. It is guaranteed that
//this random value will not be equal to the dropped value.
...
//We know that there is a defect in at most one of the sensors. Return the sensor

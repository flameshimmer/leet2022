...
//you must rotate the wheel i times before the customers[i] customers arrive. You
...
//you decide to stop serving customers, all subsequent rotations are free in
//order to get all the customers down safely. 
//Note that if there are currently

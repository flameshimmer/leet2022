...
//You are also given an integer k. You are going on a trip that crosses exactly k
//highways. You may start at any city, but you may only visit each city at most
...
//Output: 17
//Explanation:
//One possible trip is to go from 0 -> 1 -> 4 -> 3. The cost of this trip is 4 +
//11 + 2 = 17.
//Another possible trip is to go from 4 -> 1 -> 2 -> 3. The cost of this trip is
//11 + 3 + 3 = 17.
//It can be proven that 17 is the maximum possible cost of any valid trip.
//
//Note that the trip 4 -> 1 -> 0 -> 1 is not allowed because you visit the city 1
//twice.
//
//Example 2:

...
//the number of flowers already planted in the ith garden. Flowers that are
...
//
//Note that Alice could make all the gardens complete but in this case, she would
//obtain a lower total beauty.
// 
//Constraints:

...
//in a row and are labeled from 0 to n - 1 from left to right where the ith plant
//is located at x = i.
...
//cans respectively.
//- Alice waters plant 0, Bob waters plant 3.
//- Alice and Bob now have 1 unit of water each, and need to water plants 1 and 2
//respectively.
//- Since neither of them have enough water for their current plants, they refill
//their cans and then water the plants.
//So, the total number of times they have to refill to water all the plants is 0
//+ 1 + 1 + 0 = 2.
//
//Example 3:

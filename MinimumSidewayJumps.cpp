...
//There is a 3 lane road of length n that consists of n + 1 points labeled from 0
//to n. A frog starts at point 0 in the second lane and wants to jump to point n.
...
//For example, if obstacles[2] == 1, then there is an obstacle on lane 1 at point
//2.

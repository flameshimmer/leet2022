...
//sideLengthi] represents the ith square with a side length of sideLengthi that
//is dropped with its left edge aligned with X-coordinate lefti.
...
//side of another square or on the X-axis. A square brushing the left/right side
//of another square does not count as landing on it. Once it lands, it freezes in

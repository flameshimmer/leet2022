...
//Given an integer neededApples, return the minimum perimeter of a plot such that
//at least neededApples apples are inside or on the perimeter of that plot.

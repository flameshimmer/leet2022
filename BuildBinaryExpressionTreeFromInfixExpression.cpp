...
//same as s without the parenthesis. The tree also produces the correct result
//and its operands are in the same order as they appear in s.
...
//same value.
//The third tree below is also not valid. Although it produces the same result
//and is equivalent to the above trees, its inorder traversal does not produce s

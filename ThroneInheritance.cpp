...
//curOrder), which given a person x and the inheritance order so far, returns who
...
//constructor.
//void birth(string parentName, string childName) Indicates that parentName gave
//birth to childName.
...
//string[] getInheritanceOrder() Returns a list representing the current order of
...
//kingName, parentName, childName, and name consist of lowercase English letters
//only.
//All arguments childName and kingName are distinct.
//All name arguments of death will be passed to either the constructor or as
//childName to birth first.
//For each call to birth(parentName, childName), it is guaranteed that parentName
//is alive.

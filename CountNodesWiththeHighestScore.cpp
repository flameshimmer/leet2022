...
//from 0 to n - 1. You are given a 0-indexed integer array parents representing
...
//non-empty subtrees. The size of a subtree is the number of the nodes in it. The

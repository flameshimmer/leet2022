...
//house1j and house2j together using a pipe. Connections are bidirectional, and
//there could be multiple valid connections between the same two houses with
//different costs.
...
//The total cost will be 2.
//
//Note that we can connect houses 1 and 2 with cost 1 or with cost 2 but we will

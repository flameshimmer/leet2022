...
//You are given an array points where points[i] = [xi, yi] represents a point on
//an X-Y plane.
//Straight lines are going to be added to the X-Y plane, such that every point is
//covered by at least one line.

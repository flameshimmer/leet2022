...
//For example, if you want to withdraw $300 and there are 2 $50 banknotes, 1 $100
//banknote, and 1 $200 banknote, then the machine will use the $100 and $200
//banknotes.
...
//complete the remaining $100. 
//Note that the machine is not allowed to use the

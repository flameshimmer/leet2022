...
//hash(s, p, m) = (val(s[0]) * p0 + val(s[1]) * p1 + ... + val(s[k-1]) * pk-1)
//mod m.
...
//* 1 + 2 * 31 + 24 * 312) mod 100 = 23132 mod 100 = 32. 
//The hash of "bxz" can be computed to be hash("bxz", 31, 100) = (2 * 1 + 24 * 31
//+ 26 * 312) mod 100 = 25732 mod 100 = 32. 

...
//If the cell the robot is moving to is out of bounds, the robot instead turns 90
...
//Robot(int width, int height) Initializes the width x height grid with the robot
//at (0, 0) facing "East".

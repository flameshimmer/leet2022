...
//ports​​i is the port where you need to deliver the ith box and weightsi is the
//weight of the ith box.
//portsCount is the number of ports.
//maxBoxes and maxWeight are the respective box and weight limits of the ship.
//The boxes need to be delivered in the order they are given. The ship will
//follow these steps:
//The ship will take some number of boxes from the boxes queue, not violating the
//maxBoxes and maxWeight constraints.
//For each loaded box in order, the ship will make a trip to the port the box
//needs to be delivered to and deliver it. If the ship is already at the correct
//port, no trip is needed, and the box can immediately be delivered.

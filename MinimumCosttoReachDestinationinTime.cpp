...
//passingFees[j] is the amount of dollars you must pay when you pass through city
//j.
//In the beginning, you are at city 0 and want to reach city n - 1 in maxTime
//minutes or less. The cost of your journey is the summation of passing fees for
//each city that you passed through at some moment of your journey (including the
//source and destination cities).
//Given maxTime, edges, and passingFees, return the minimum cost to complete your

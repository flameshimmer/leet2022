...
//yi1, xi2, yi2] denotes the ith rectangle where (xi1, yi1) are the coordinates
//of the bottom-left corner, and (xi2, yi2) are the coordinates of the top-right
//corner.
...
//Return the total area. Since the answer may be too large, return it modulo 109
//+ 7.
// 
//
//Example 1:

...
//You are given a 0-indexed 2D integer array grid of size m x n that represents a
//map of the items in a shop. The integers in the grid represent the following:
...
//You are also given integer arrays pricing and start where pricing = [low, high]
//and start = [row, col] indicates that you start at the position (row, col) and
...
//(highest to lowest). If there are fewer than k reachable items within the price
